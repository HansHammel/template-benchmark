...
//-*- mode: js2-mode; indent-tabs-mode: t; tab-width: 2; -*-
    ...
    function elementTypeOf(context) {
        return context & ELEMENT_TYPE_ALL;
    }
    ...
    function attrTypeOf(context) {
        return context & ATTR_TYPE_ALL;
    }
    ...
    function delimTypeOf(context) {
        return context & DELIM_TYPE_ALL;
    }
    ...
    function uriPartOf(context) {
        return context & URI_PART_ALL;
    }
...
//-*- mode: js2-mode; indent-tabs-mode: t; tab-width: 2; -*-
    ...
    function contextToString(context) {
        ...
        switch (stateOf(context)) {
            case STATE_HTML_PCDATA:
                parts.push("HTML_PCDATA");
                break;
            case STATE_HTML_RCDATA:
                parts.push("HTML_RCDATA");
                break;
            case STATE_HTML_BEFORE_TAG_NAME:
                parts.push("HTML_BEFORE_TAG_NAME");
                break;
            case STATE_HTML_TAG_NAME:
                parts.push("HTML_TAG_NAME");
                break;
            case STATE_HTML_TAG:
                parts.push("HTML_TAG");
                break;
            case STATE_HTML_ATTRIBUTE_NAME:
                parts.push("HTML_ATTRIBUTE_NAME");
                break;
            case STATE_HTML_BEFORE_ATTRIBUTE_VALUE:
                parts.push("HTML_BEFORE_ATTRIBUTE_VALUE");
                break;
            case STATE_HTML_COMMENT:
                parts.push("HTML_COMMENT");
                break;
            case STATE_HTML_NORMAL_ATTR_VALUE:
                parts.push("HTML_NORMAL_ATTR_VALUE");
                break;
            case STATE_CSS:
                parts.push("CSS");
                break;
            case STATE_CSS_COMMENT:
                parts.push("CSS_COMMENT");
                break;
            case STATE_CSS_DQ_STRING:
                parts.push("CSS_DQ_STRING");
                break;
            case STATE_CSS_SQ_STRING:
                parts.push("CSS_SQ_STRING");
                break;
            case STATE_CSS_URI:
                parts.push("CSS_URI");
                break;
            case STATE_CSS_DQ_URI:
                parts.push("CSS_DQ_URI");
                break;
            case STATE_CSS_SQ_URI:
                parts.push("CSS_SQ_URI");
                break;
            case STATE_JS:
                parts.push("JS");
                break;
            case STATE_JS_LINE_COMMENT:
                parts.push("JS_LINE_COMMENT");
                break;
            case STATE_JS_BLOCK_COMMENT:
                parts.push("JS_BLOCK_COMMENT");
                break;
            case STATE_JS_DQ_STRING:
                parts.push("JS_DQ_STRING");
                break;
            case STATE_JS_SQ_STRING:
                parts.push("JS_SQ_STRING");
                break;
            case STATE_JS_REGEX:
                parts.push("JS_REGEX");
                break;
        ...
        switch (jsFollowingSlashOf(context)) {
            ...
            case JS_FOLLOWING_SLASH_DIV_OP:
                parts.push("DIV_OP");
                break;
            case JS_FOLLOWING_SLASH_UNKNOWN:
                parts.push("UNKNOWN");
                break;
        }
        switch (uriPartOf(context)) {
            case URI_PART_START:
                parts.push("START");
                break;
            case URI_PART_PRE_QUERY:
                parts.push("PRE_QUERY");
                break;
            case URI_PART_QUERY:
                parts.push("QUERY");
                break;
            ...
            case URI_PART_UNKNOWN_PRE_FRAGMENT:
                parts.push("UNKNOWN_PRE_FRAGMENT");
                break;
            case URI_PART_UNKNOWN:
                parts.push("UNKNOWN");
                break;
        }
    ...
    var processRawText = ( function () {
        ...
        function TransitionSubclass(ctor, computeNextContext, opt_isApplicableTo) {
            ...
            if (opt_isApplicableTo) {
                proto.isApplicableTo = opt_isApplicableTo;
            }
        }
        ...
        TransitionSubclass(
            ...
            function (prior, match) {
                ...
                if (typeof partialContext !== "number") {
                    throw new Error(elType);
                }
    ...
    function computeEscapingModeForSubst(contextBefore, out) {
        ...
        switch (uriPartOf(context)) {
            ...
            case URI_PART_PRE_QUERY:
                ...
                break;
            default:
                return STATE_ERROR;  // Unknown URI part.
        }
        ...
        if (delimType !== DELIM_TYPE_NONE) {
            switch (firstEscMode) {
                ...
                case ESC_MODE_ESCAPE_HTML_ATTRIBUTE:
                    ...
                    break;
                case ESC_MODE_ESCAPE_HTML_ATTRIBUTE_NOSPACE:
                    break;
                default:
    ...
    function autoescape(jqueryTemplatesByName) {
        ...
        function getTemplateOutputContext(templateBody, inputContext, parentInferences) {
        ...
        function mutate(parseTreeNode) {
            ...
            switch (parseTreeNode[0]) {
                ...
                case "=":  // Add escaping directives.
                    ...
                    break;
                case "tmpl":
                case "wrap":  // Rewrite calls in context.
